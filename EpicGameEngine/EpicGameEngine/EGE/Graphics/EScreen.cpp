...
namespace
{
	EGE::Graphics::EScreen* gEScreen = 0;
}

LRESULT CALLBACK
MainWndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	return gEScreen->MsgProc(hwnd, msg, wParam, lParam);
}
...
namespace EGE { namespace Graphics{
	...
	EScreen::EScreen(int width, int height)
	{
		gEScreen = this;
